                  ...
                  <div class="row">
                    <div class="col-sm-12">
                          ...
                          <div class="card card-outline card-indigo"  id="official_body">
                            ...
                            <h1 class="card-title" style="font-weight:  700;"> <i class="fas fa-users-cog"></i> ITEMS <span class="badge badge-secondary text-lg"><?= $row_total_official['total_official'] ?? 0?></span></h1>   
